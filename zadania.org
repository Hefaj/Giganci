* TODO Zadanka[0/4]
   1. [-] Konsola [2/14]
	 ...
	 - Podpowiedz:
      ...
      3) [ ] Liczba Eulera
	 - Napiszaæ program liczb±cy przybli¿enie liczby Eulera
	 - Problem:
	   * Co to jest liczba Eulera, jak j± liczyæ?
	 - Podpowiedz:
	   * e = sum(1/n!) czyli 1/0! + 1/1! + 1/2! + ...
	   * zrobic z silni funkcje
	 ...
	 - Podaj±c liczbê, ma zostaæ ona wy¶wietlona w postaci sumy liczb.
	   1234 = 1000 + 200 + 30 + 4
	 - Problem:
	   * Jak przechwyciæ pojedyñcze cyfry?
	 - Podpowiedz:
	   * string to tablica charów 
	     string liczba = "1234";
	     liczba[0] => "1";
	   * stringki mozna sklejaæ za pomoc± znaku "+"
	 ...
	 - Podpowiedz:
	   ...
	   * znajdz wszystkie dzielniki podanej liczby i zapisuj je do tablicy
	  ...
	  - Maj±c funkcje f(x) chcemy znale¼æ miesce zerowe z przebia³u <a,b>
	  - Problem:
	    * Jak?
	  - Podpowiedz:
	    * Metoda bisekcji
      ...
      13) [ ] Perceptron
	  - Stworzyæ perceptron 2 wejscia 1 wyjscie.
	  - Problem:
	  ...
	  - Stworzyæ algorytm uczenia perceptrony
		 Czyli modyfikacji wag (w) aby zwraca³o co chemy
	  - Problem:
   ...
   2. [-] WinForms [3/7]
	 ...
	 - Problem:
	   ...
	   * Jak zmieniæ z pozycji kodu kodu pozycjê textboxa?
	 - Podpowiedz:
      ...
      4) [X] Dynamiczna zmiana koloru checkbox-a
	 - Wpisuj±c w textbox-a ma siê zmieniaæ kolor t³a.
	 - Problem:
	   * Jak zmienaæ kolor t³a?
	 - Podpowiedz:
	 ...
	 - Problem:
	   * W jaki sposób komputer "rozumie" kolory, jak siê je przedstaiwa, [[https://pl.wikipedia.org/wiki/RGB][RGB]], [[https://pl.wikipedia.org/wiki/CMYK][CMYK]] i inne?
	   * Jak losowaæ liczby?
	 ...
	 - Problem:
	   ...
	   * Jak wykonywaæ kod w pêtki co okre¶lony czas?
	 - Podpowiedz:
   ...
   3. [ ] HARD MODE [0/2]
      1) [ ] [[https://github.com/Hefaj/portfolio/tree/master/Python/simulation][Ro¶lino¿ercy i miêso¿ercy]] 
